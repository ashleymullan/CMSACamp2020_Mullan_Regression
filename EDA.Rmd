...
for (i in 1:16){
  percentage_stats_model_linear_fit_points <- crossValidatorInator(data_copy_for_adding_fold_id, avg_points ~ win_perc + field_goal_perc + three_point_perc + free_throw_perc + two_point_perc, i)
}
#for(i in 1:16) {plot(percentage_stats_model_linear_fit_points[[i]])}
str(percentage_stats_model_linear_fit_points[1])
